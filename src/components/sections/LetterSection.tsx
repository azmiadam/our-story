  ...
  return (
    <section className="py-24 px-4 bg-primary-50 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        <div className="relative bg-white/60 backdrop-blur-2xl border border-white/80 shadow-2xl shadow-primary-500/10 rounded-[2rem] p-8 md:p-14 overflow-hidden before:absolute before:inset-0 before:bg-gradient-to-br before:from-white/50 before:via-transparent before:to-white/20 before:pointer-events-none">
          ...
          <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-white/90 via-white/70 to-transparent pointer-events-none flex items-end justify-center pb-6 rounded-b-[2rem]">
